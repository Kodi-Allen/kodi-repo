...
Generates addons.xml and addons.xml.md5 for the repository
"""
...
def create_addon_zip(addon_dir):
    ...
    # Read addon.xml to get ID and version
...
def generate_md5():
    """Generate the addons.xml.md5 file"""
...
if __name__ == '__main__':
    ...
    print("\n" + "=" * 50)
    print("Done! Repository is ready for GitHub.")
    print("=" * 50)
